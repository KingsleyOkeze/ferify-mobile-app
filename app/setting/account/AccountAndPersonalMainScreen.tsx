    ...
    const menuItems = [
        {
            ...
            icon: 'person-outline',
            onPress: () => { router.push('/setting/account/AccountDetailsScreen') },
        },
        {
            id: 'transport',
            ...
            icon: 'bus-outline',
            onPress: () => { router.push('/setting/account/TransportPreferenceScreen') },
        },
        {
            id: 'privacy',
            title: 'Data & privacy',
            ...
            onPress: () => { router.push('/setting/account/DataAndPrivacyScreen') },
        },
        {
            id: 'security',
            title: 'Security',
            ...
            onPress: () => { router.push('/setting/account/AccountSecurityScreen') },
        },
    ];
