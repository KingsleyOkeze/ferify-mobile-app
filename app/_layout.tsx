        ...
        <>
            ...
            >
                ...
                >
                    ...
                    />
                    <Stack.Screen name="account/DataAndPrivacyScreen"
                        options={{
                            presentation: "modal",
                            animation: "slide_from_right",
                            gestureEnabled: true,
                    ...
                    />
                    <Stack.Screen name="setting/ContributionVisibilitySettingScreen"
                        options={{
                            presentation: "modal",
                            animation: "slide_from_right",
                            gestureEnabled: true,
                    ...
                    />
                    <Stack.Screen name="setting/UpdateUsernameScreen"
                        options={{
                            presentation: "modal",
                            animation: "slide_from_right",
                            gestureEnabled: true,
                    ...
                    />
                    <Stack.Screen name="setting/UpdateUserFullNameScreen"
                        options={{
                            presentation: "modal",
                            animation: "slide_from_right",
                            gestureEnabled: true,
                    ...
                    />
                    <Stack.Screen name="setting/UpdateUserEmailScreen"
                        options={{
                            presentation: "modal",
                            animation: "slide_from_right",
                            gestureEnabled: true,
                    ...
                    />
                    <Stack.Screen name="setting/UpdateUserPhoneNumberScreen"
                        options={{
                            presentation: "modal",
                            animation: "slide_from_right",
                            gestureEnabled: true,
                    ...
                    />
                    <Stack.Screen name="setting/PasswordResetScreen"
                        options={{
                            presentation: "modal",
                            animation: "slide_from_right",
                            gestureEnabled: true,
                    ...
                    />
                    <Stack.Screen name="settingPrivacy&SafetySettingScreen"
                        options={{
                            presentation: "modal",
                            animation: "slide_from_right",
                            gestureEnabled: true,
                    ...
                    />
                    <Stack.Screen name="setting/LocationDataSettingScreen"
                        options={{
                            presentation: "modal",
                            animation: "slide_from_right",
                            gestureEnabled: true,
